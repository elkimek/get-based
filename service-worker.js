...
const APP_SHELL = [ // Includes dynamic chat and Knowledge Base modules for first-launch offline use.
  '/version.js', '/service-worker-runtime.js', '/shared/agent-host-protocol.js', '/shared/agent-tool-contract.js',
  '/index.html', '/app',
  '/styles.css', '/css/app-shell.css', '/css/import.css', '/css/emf.css', '/css/modal-shared.css',
  '/css/dashboard-core.css', '/css/dashboard-widgets.css', '/css/dashboard-welcome.css', '/css/dashboard-data.css', '/css/category-views.css',
  ...
  '/css/wearables.css',
  '/css/nutrition.css',
  '/css/light-sun.css', '/css/light-channels.css', '/css/light-devices.css', '/css/light-conditions-now.css', '/css/light-setup.css', '/css/light-tools.css', '/css/light-env.css',
  '/css/chat-panel.css', '/css/chat-panel-open.css', '/css/chat-personality.css', '/css/chat-messages.css', '/css/chat-composer.css', '/css/chat-onboarding.css',
  ...
  '/js/profile-data-migrations.js', '/js/profile-data-writes.js', '/js/profile-import-provenance.js', '/js/profile-load-safety.js',
  ...
  '/js/lab-entry.js', '/js/lab-entry-restore.js',
  '/js/lab-entry-mutations.js', '/js/lab-vitamin-d-context.js',
  ...
  '/js/image-utils.js',
  '/js/pdf-import.js',
  '/js/pdf-import-commit.js', '/js/import-commit-validation.js',
  ...
  '/js/export-report.js', '/js/export-report-data.js', '/js/export-report-sections.js', '/js/export-report-aggregates.js', '/js/export-report-summary-html.js',
  '/js/export-report-html.js',
  '/js/export-report-builder.js', '/js/export-report-progress.js',
  '/js/chat.js',
  '/js/chat-window-bindings.js',
  '/js/chat-marker-prompts.js',
  '/js/chat-attestation.js',
  '/js/chat-actions.js', '/js/agent-draft-claims.js',
  '/js/chat-nudge.js',
  ...
  '/js/chat-layout.js', '/js/chat-model-controls.js',
  '/js/chat-model-preferences.js', '/js/chat-runtime.js',
  '/js/chat-render-runtime.js', '/js/chat-render.js',
  '/js/chat-message-avatars.js', '/js/chat-thinking-status.js',
  '/js/chat-composer.js', '/js/chat-recommendation-disclosure.js',
  '/js/chat-scroll.js', '/js/chat-storage-safety.js',
  '/js/chat-send.js',
  '/js/chat-send-runtime.js',
  '/js/chat-backend-selection.js',
  '/js/agent-chat-backend.js', '/js/agent-chat-context.js',
  '/js/agent-chat-client.js', '/js/agent-host-discovery.js',
  '/js/agent-chat-settings.js', '/js/agent-drafts.js',
  '/js/settings-cli-agent-panel.js',
  '/js/cli-agent-brand-assets.js',
  '/js/agent-feature-inference.js',
  '/js/agent-model-catalog.js',
  '/js/ai-execution-routing.js',
  '/js/agent-tool-runtime.js',
  '/js/agent-tool-bindings.js',
  '/js/ai-feature-routing.js',
  '/brands/cli-agent-codex.svg',
  ...
  '/js/biology-score-panel-policy.js', '/js/biology-score-contract.js', '/js/biology-score-methodology.js',
  '/js/biology-score-mappings.js', '/js/biology-score-profile-modifiers.js',
  '/js/biology-score-sections.js', '/js/biology-score-persistence.js',
  ...
  '/js/cashu-wallet-store.js', '/js/cashu-funding-coordinator.js',
  ...
  '/js/wearables-store.js', '/js/wearables-manual-lock.js', '/js/wearables-whoop-storage.js',
  '/js/nutrition-store.js',
  '/js/nutrition-sync-sanitize.js',
  '/js/demo-nutrition.js', '/js/demo-biology-data.js', '/js/demo-biology-insights.js', '/js/nutrition-fuel-mix.js',
  ...
  '/icon-512.png',
  '/manifest.json',
  '/brands/ai-provider-ppq.svg', '/brands/ai-provider-routstr.svg',
  '/brands/ai-provider-openrouter.svg', '/brands/ai-provider-venice.svg',
  '/brands/cli-agent-grok.svg',
  '/brands/oura/mark-mono.svg', '/brands/oura/wordmark-on-dark.svg', '/brands/oura/wordmark-on-light.svg',
  '/brands/withings/mark-mono.svg', '/brands/withings/wordmark-on-dark.svg', '/brands/withings/wordmark-on-light.svg',
  '/brands/ultrahuman/mark-mono.svg', '/brands/ultrahuman/wordmark-on-dark.svg', '/brands/ultrahuman/wordmark-on-light.svg',
  '/brands/whoop/mark-mono.svg', '/brands/whoop/wordmark-on-dark.svg', '/brands/whoop/wordmark-on-light.svg',
  '/brands/fitbit/mark-mono.svg',
  '/brands/google-health/mark-mono.svg', '/brands/polar/mark-mono.svg', '/brands/apple-health/mark-mono.svg',
  '/vendor/chart.min.js',
  ...
  '/vendor/fonts/inter-400.woff2', '/vendor/fonts/inter-400-2.woff2', '/vendor/fonts/inter-400-3.woff2', '/vendor/fonts/inter-400-4.woff2', '/vendor/fonts/inter-400-5.woff2', '/vendor/fonts/inter-400-6.woff2', '/vendor/fonts/inter-400-7.woff2',
  '/vendor/fonts/inter-500.woff2', '/vendor/fonts/inter-500-2.woff2', '/vendor/fonts/inter-500-3.woff2', '/vendor/fonts/inter-500-4.woff2', '/vendor/fonts/inter-500-5.woff2', '/vendor/fonts/inter-500-6.woff2', '/vendor/fonts/inter-500-7.woff2',
