...
const APP_SHELL = [ // Includes dynamic chat and Knowledge Base modules for first-launch offline use.
  ...
  '/js/chat-layout.js',
  '/js/chat-model-controls.js',
  '/js/chat-model-preferences.js',
  '/js/chat-runtime.js',
  ...
  '/js/agent-chat-backend.js',
  '/js/agent-chat-context.js',
  '/js/agent-chat-client.js',
  '/js/agent-host-discovery.js',
  '/js/agent-chat-settings.js',
  '/js/agent-drafts.js',
