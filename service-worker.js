...
const APP_SHELL = [
  ...
  '/js/lab-order-coverage.js',
  '/js/lab-plan-intent.js',
  '/js/lab-plan-ai.js',
  '/js/lab-order-render.js',
  '/js/lab-standards/standards-types.js',
  '/js/lab-standards/marker-crosswalk.js',
  '/js/lab-standards/nclp-client.js',
  '/js/lab-standards/nclp-cache.js',
  '/js/lab-standards/nclp-resolver.js',
  '/js/lab-providers/provider-registry.js',
  '/js/lab-providers/provider-catalog-matcher.js',
  '/js/lab-providers/provider-catalogue-source.js',
  '/js/lab-providers/cz/labshop-catalog.js',
  '/js/lab-providers/cz/unilabs-catalog.js',
  '/js/lab-providers/cz/labshop.js',
  '/js/lab-providers/cz/unilabs.js',
  '/js/chat-icons.js',
