...
const APP_SHELL = [
  ...
  '/js/chat-send.js',
  '/js/agent-tools.js',
  '/js/agent-context-schema.js',
  '/js/agent-response-synthesis.js',
  '/js/agent-artifacts.js',
  '/js/agent-access-proposals.js',
  '/js/agent-proposal-inbox.js',
  '/js/agent-artifact-library.js',
  '/js/agent-intent-router.js',
  '/js/agent-actions/schemas.js',
  '/js/agent-actions/registry.js',
  '/js/agent-runtime.js',
  '/js/chat-icons.js',
