...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        'js/voice-player.js': { lines: 91, functions: 79, branches: 73, statements: 86 },
        'js/voice-local-tts-worker.js': { lines: 99, functions: 90, branches: 95, statements: 99 },
        'lib/acp-agent-client.js': { lines: 95, functions: 85, branches: 80, statements: 89 },
        'lib/codex-app-server-client.js': { lines: 96, functions: 86, branches: 77, statements: 89 },
