...
| Grok Build | xAI mark from OpenCode's official provider icon set, checked against the SpaceXAI symbol linked by the official `xai-org/grok-build` repository | SpaceXAI requires accurate referential use and no suggestion of endorsement. Keep the mark unaltered and beside “Grok Build.” |

Primary guidance reviewed:

- OpenAI Design Guidelines: https://openai.com/brand/
- Anthropic newsroom media assets: https://www.anthropic.com/news
- OpenCode identity assets: https://github.com/anomalyco/opencode/tree/dev/packages/identity
