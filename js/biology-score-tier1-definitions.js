...
export const TIER1_BIOLOGY_SCORE_DEFINITIONS = [
  {
    ...
    inputs: [
      { key: 'homocysteine', label: 'Homocysteine load', weight: 1.8, paths: 'coagulation.homocysteine' },
      { key: 'b12', label: 'Vitamin B12', weight: 1.1, paths: 'vitamins.vitaminB12' },
      { key: 'folate', label: 'Folate', weight: 1.1, paths: 'vitamins.folate' },
  ...
  {
    id: 'fluidFiltrationCoherence', title: 'Fluid & Filtration Coherence', kicker: 'Kidney + hydration context', evidence: 'contextual', panelTier: 'minimum', coherenceDomain: 'kidney', coherenceWeight: 1.0,
    summary: 'Kidney filtration, hydration, and electrolyte context that can distort interpretation of other lab patterns.',
    inputs: [
      { key: 'egfr', label: 'eGFR filtration', weight: 1.45, paths: ['biochemistry.egfr', 'biochemistry.eGFR'] },
      { key: 'creatinine', label: 'Creatinine', weight: 1.0, paths: 'biochemistry.creatinine' },
      ...
      { key: 'sodium', label: 'Sodium', weight: 0.85, paths: 'electrolytes.sodium' },
      { key: 'potassium', label: 'Potassium', weight: 0.85, paths: 'electrolytes.potassium' },
  ...
  {
    id: 'liverBileSignal', title: 'Liver–Bile Signal', kicker: 'Hepatic flow context', evidence: 'contextual', panelTier: 'minimum', coherenceDomain: 'liver', coherenceWeight: 1.0,
    summary: 'Liver enzyme, bile-flow, protein synthesis, and metabolic burden pattern.',
    inputs: [
      { key: 'alt', label: 'ALT liver-cell signal', weight: 1.15, paths: 'biochemistry.alt' },
      { key: 'ast', label: 'AST liver/muscle signal', weight: 0.9, paths: 'biochemistry.ast' },
      { key: 'ggt', label: 'GGT bile/toxin signal', weight: 1.2, paths: 'biochemistry.ggt' },
      { key: 'alp', label: 'ALP bile/bone context', weight: 0.9, paths: 'biochemistry.alp' },
  ...
  {
    id: 'boneMineralSignal', title: 'Bone–Mineral Signal', kicker: 'D–calcium coherence', evidence: 'contextual', panelTier: 'minimum', coherenceDomain: 'mineral', coherenceWeight: 1.0,
    summary: 'Vitamin D, calcium-phosphate, kidney, and bone-turnover context for mineral signaling.',
    inputs: [
      { key: 'vitaminD', label: '25-OH vitamin D', weight: 1.45, paths: 'vitamins.vitaminD' },
      { key: 'calcium', label: 'Total calcium', weight: 1.0, paths: 'electrolytes.calciumTotal' },
      { key: 'phosphorus', label: 'Phosphorus', weight: 0.85, paths: 'electrolytes.phosphorus' },
