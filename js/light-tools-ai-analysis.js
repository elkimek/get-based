...
const SYSTEM_PROMPT = [
  ...
  'darkness (sleep room, captured at night): <0.1 lux → green; 0.1–1 lux → yellow; >1 lux → red because it exceeds the app nighttime reference. Camera lux is approximate.',
  'CCT: describe warm/cool appearance and timing, but do not infer melanopic potency or sleep safety from CCT alone. PWM-active flag → yellow regardless.',
  'spectrum: describe the likely source class and camera confidence. Do not call any source sleep-safe from RGB or CCT alone.',
