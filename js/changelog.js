...
const CHANGELOG = [
  {
    version: '1.8.357', date: '2026-06-03', title: 'Private profile sharing',
    items: [
      ...
      '<b>Hosted share safeguards.</b> The share endpoint now rejects weak key-derivation metadata, rate-limits anonymous link creation with fixed hourly slots, and keeps localhost CORS limited to local development.',
    ]
  },
  {
