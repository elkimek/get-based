...
const CHANGELOG = [ { version: '1.20.2', date: '2026-09-01', title: 'Agent proposals now arrive in local previews', forceShow: true, items: [ '<b>Agent proposals now connect to the isolated local preview identity.</b> The encrypted preview relay and your browser use the same disposable profile, so waiting proposals can actually reach the review card.', '<b>Your approval boundary is unchanged.</b> You still review each proposal before choosing Apply or Dismiss, and nothing is applied automatically.' ] },
  { version: '1.20.0', date: '2026-09-01', title: 'External agents can prepare changes for your approval', items: [ '<b>Connected agents can now send encrypted action proposals into your Context inbox.</b> The relay stores ciphertext only, and the browser rejects proposals for the wrong profile, expired capabilities, or unsupported actions.', '<b>External proposals still cannot change your health record by themselves.</b> You review each sunlight session and explicitly Apply or Dismiss it; retries use the same durable proposal ID so one approval cannot create duplicate sessions.' ] },
  { version: '1.19.0', date: '2026-09-01', title: 'Chat can prepare app changes for your review', items: [ '<b>Tell Chat that you finished a sunlight session.</b> It can understand the update in your own words and prepare a completed Sun session with the duration and time filled in.', '<b>You review every change before it reaches your profile.</b> The proposed action stays in Chat, and nothing changes until you choose Apply. Cancel leaves your Sun sessions untouched.' ] },
