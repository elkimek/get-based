...
export const BIOCHEMISTRY_CATEGORY = {
  ...
  markers: {
    ...
    egfrCombined: { name: "eGFR (Creatinine + Cystatin C)", rangePolicy: "contextual", unit: "ml/s/1.73m\u00b2", refMin: null, refMax: null, desc: "Reported filtration estimate using both creatinine and cystatin C. Use the reporting laboratory's interval and equation context; KitBasis does not derive this estimate from the component concentrations. Muscle mass and non-filtration influences on either marker still matter." },
