...
const TOUR_STEPS = [
  ...
  { target: '.nav-item[data-category="labs"], #sidebar-toggle, .m-tabbar', title: 'Five Lenses', text: 'Move between Dashboard, Labs, Genome, Body, Light, Insight, and Tips. Desktop uses the sidebar; smaller screens use tabs and the menu.', position: 'right' },
  { target: '.dashboard-greeting', title: 'Dashboard Overview', text: 'The dashboard summarizes the current profile. After import, widgets surface focus areas, priorities, general-information tips, body data, and light context.', position: 'bottom' },
