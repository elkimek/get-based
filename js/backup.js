...
const GLOBAL_SETTINGS_KEYS = [
  ...
  'labcharts-ollama', 'labcharts-ollama-model', 'labcharts-ollama-models',
  'labcharts-agent-router-mode', 'labcharts-agent-router-provider',
  'labcharts-agent-router-openrouter-model', 'labcharts-agent-router-venice-model',
  'labcharts-agent-router-routstr-model', 'labcharts-agent-router-ppq-model',
  'labcharts-agent-router-custom-model', 'labcharts-agent-router-ollama-model',
