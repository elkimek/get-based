...
export const MODELS = {
  'all-minilm': {
    ...
    downloadMB: 22,
    language: 'en',
    notes: 'Quickest imports and the smallest download. Good for compact English collections.',
  },
  'bge-small-en': {
    ...
    downloadMB: 33,
    language: 'en',
    notes: 'Stronger English matching without the large performance cost of BGE-base.',
  },
  'multilingual-e5-small': {
    ...
    downloadMB: 40,
    language: 'multi',
    notes: 'Choose this when your documents use multiple languages.',
  },
  'bge-base-en': {
    ...
    downloadMB: 110,
    language: 'en',
    notes: 'Best English matching, with a much larger download and slower CPU indexing.',
  },
};
