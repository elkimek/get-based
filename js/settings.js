...
export function openSettingsModal(tab) {
  ...
  modal.innerHTML = `
    ...
    <div class="settings-tab-panel${_activeSettingsTab === 'ai' ? ' active' : ''}" data-tab-panel="ai">
      ...
      <details class="settings-section" id="ai-provider-advanced-section" open>
        <summary style="cursor:pointer;font-weight:600;color:var(--text-primary);margin-bottom:10px">Bring your own key / local AI</summary>
