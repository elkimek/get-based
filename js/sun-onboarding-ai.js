...
const SYSTEM_PROMPT = [
  ...
  '  red = several recorded light-environment gaps, especially a bright sleep room or heavy evening light',
  '  gray = not enough data (defaults missing)',
  '',
  'Weigh signals together, but do not infer medicine-specific burn timing from a category flag. A photosensitivity warning should pause exposure-seeking advice and direct the user to the product label or clinician. Describe evening light and dark-room patterns plainly without alarmist language.',
  '',
