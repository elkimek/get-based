...
describe('API provider runtime behavior', () => {
  ...
  it('filters Routstr and PPQ models and preserves provider-specific pricing semantics', async () => {
    ...
    expect(routstrModels.map(m => m.id)).toEqual(['claude-sonnet-4.6', 'claude-sonnet-5', 'grok-41-fast', 'x-ai/grok-4.3', 'moonshotai/kimi-k3', 'z-ai/glm-5.2', 'llama-3.1-8b', 'qwen/qwen3.8-27b']);
    ...
    expect(ppqModels.map(m => m.id)).toEqual(['claude-sonnet-4.6', 'claude-sonnet-5', 'google/gemini-3.5-flash', 'grok-4.20', 'x-ai/grok-4.3', 'moonshotai/kimi-k3', 'z-ai/glm-5.2', 'moonshotai/kimi-k2.7-code', 'qwen/qwen3.8-27b', 'perplexity/sonar']);
  ...
  it('reports model capabilities across providers', () => {
    ...
    expect(isRecommendedModel('openrouter', 'z-ai/glm-5.3')).toBe(true);
    ...
    expect(isRecommendedModel('venice', 'zai-org-glm-5-3')).toBe(true);
    ...
    expect(isRecommendedModel('routstr', 'z-ai/glm-5.3')).toBe(true);
    ...
    expect(isRecommendedModel('ppq', 'z-ai/glm-5.3')).toBe(true);
    ...
    expect(isRecommendedModel('custom', 'z-ai/glm-5.3')).toBe(true);
