 ...
 *   agents?: Array<{id: string, name: string, description: string, version?: string, status?: string, message?: string, compatible?: boolean, protocol: 'codex'|'acp'|'claude'|'openclaw', client: any}>,
 *   bundlePath?: string,
