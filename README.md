...
| **CLI agents (desktop preview)** | Use an existing signed-in Codex, Claude Code, OpenCode, Hermes, or Grok subscription for chat and supported AI features through the local getbased Companion on Linux, macOS, or Windows. Health-data changes remain reviewable drafts. |
