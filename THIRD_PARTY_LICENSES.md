...
| `cashu-ts.js` | [cashu-ts](https://github.com/cashubtc/cashu-ts) | 4.7.0 | MIT | https://github.com/cashubtc/cashu-ts/blob/main/LICENSE |
...
| `ppq-private-tee.js`, `tinfoil-browser.js` | [Tinfoil JS](https://github.com/tinfoilsh/tinfoil-js) browser SecureClient bundle for PPQ Private TEE mode | 1.1.7 | AGPL-3.0-or-later | https://github.com/tinfoilsh/tinfoil-js/blob/main/LICENSE |
