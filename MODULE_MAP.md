...
- [`js/sync-chat-apply.js`](js/sync-chat-apply.js) → [`js/chat-personality-storage.js`](js/chat-personality-storage.js), [`js/crypto.js`](js/crypto.js), [`js/state.js`](js/state.js), [`js/sync-chat-merge.js`](js/sync-chat-merge.js), [`js/sync-payload-collectors.js`](js/sync-payload-collectors.js), [`js/sync-state.js`](js/sync-state.js)
