...
| [`js/state.js`](js/state.js) | 193 | [`js/app-light-sun-modules.js`](js/app-light-sun-modules.js) | 36 |
| [`js/caught-error.js`](js/caught-error.js) | 88 | [`js/chat-send.js`](js/chat-send.js) | 32 |
...
| [`js/chat-runtime.js`](js/chat-runtime.js) | 19 | [`js/app-chat-hooks.js`](js/app-chat-hooks.js) | 19 |
...
- [`js/agent-proposal-ui.js`](js/agent-proposal-ui.js) → [`js/chat-message-action-attrs.js`](js/chat-message-action-attrs.js), [`js/utils.js`](js/utils.js)
- [`js/agent-runtime.js`](js/agent-runtime.js) → [`js/agent-actions/registry.js`](js/agent-actions/registry.js), [`js/api.js`](js/api.js), [`js/chat-history.js`](js/chat-history.js), [`js/chat-render.js`](js/chat-render.js), [`js/state.js`](js/state.js), [`js/utils.js`](js/utils.js)
...
- [`js/app-health-data-modules.js`](js/app-health-data-modules.js) → [`js/context-cards.js`](js/context-cards.js), [`js/cycle.js`](js/cycle.js), [`js/dna.js`](js/dna.js), [`js/charts.js`](js/charts.js), [`js/notes.js`](js/notes.js), [`js/recommendations.js`](js/recommendations.js), [`js/supplements.js`](js/supplements.js)
...
- [`js/context-card-lifestyle-runtime.js`](js/context-card-lifestyle-runtime.js) → [`js/context-cards-runtime.js`](js/context-cards-runtime.js), [`js/chat-runtime.js`](js/chat-runtime.js)
...
<details><summary><code>data</code> family — 6 modules</summary>
...
- [`js/dna-runtime.js`](js/dna-runtime.js) → [`js/context-cards-runtime.js`](js/context-cards-runtime.js), [`js/chat-runtime.js`](js/chat-runtime.js), [`js/pdf-import-progress.js`](js/pdf-import-progress.js), [`js/profile.js`](js/profile.js), [`js/utils.js`](js/utils.js)
...
- [`js/chat-context-status.js`](js/chat-context-status.js) → [`js/api.js`](js/api.js), [`js/context-source-registry.js`](js/context-source-registry.js), [`js/chat-runtime.js`](js/chat-runtime.js), [`js/lens.js`](js/lens.js), [`js/state.js`](js/state.js), [`js/utils.js`](js/utils.js)
...
- [`js/chat-discussion-picker.js`](js/chat-discussion-picker.js) → [`js/constants.js`](js/constants.js), [`js/chat-message-action-attrs.js`](js/chat-message-action-attrs.js), [`js/chat-personalities.js`](js/chat-personalities.js), [`js/state.js`](js/state.js), [`js/utils.js`](js/utils.js)
...
- [`js/chat-discussion-round-state.js`](js/chat-discussion-round-state.js) → [`js/crypto.js`](js/crypto.js), [`js/chat-history.js`](js/chat-history.js), [`js/chat-threads.js`](js/chat-threads.js), [`js/state.js`](js/state.js)
- [`js/chat-discussion-round-view.js`](js/chat-discussion-round-view.js) → [`js/app-extension-runtime.js`](js/app-extension-runtime.js), [`js/chat-attestation.js`](js/chat-attestation.js), [`js/chat-continuation.js`](js/chat-continuation.js), [`js/chat-discussion-round-state.js`](js/chat-discussion-round-state.js), [`js/markdown.js`](js/markdown.js), [`js/schema.js`](js/schema.js), [`js/utils.js`](js/utils.js)
- [`js/chat-discussion-state.js`](js/chat-discussion-state.js) → [`js/constants.js`](js/constants.js), [`js/chat-personalities.js`](js/chat-personalities.js), [`js/chat-threads.js`](js/chat-threads.js), [`js/state.js`](js/state.js)
...
- [`js/chat-personality-storage.js`](js/chat-personality-storage.js) → [`js/crypto.js`](js/crypto.js), [`js/chat-storage-safety.js`](js/chat-storage-safety.js), [`js/state.js`](js/state.js)
...
- [`js/chat-thread-search.js`](js/chat-thread-search.js) → [`js/crypto.js`](js/crypto.js), [`js/chat-message-action-attrs.js`](js/chat-message-action-attrs.js), [`js/chat-scroll.js`](js/chat-scroll.js), [`js/state.js`](js/state.js), [`js/utils.js`](js/utils.js)
...
- [`js/light-channel-view-hooks.js`](js/light-channel-view-hooks.js) → [`js/light-devices-store.js`](js/light-devices-store.js), [`js/light-devices.js`](js/light-devices.js), [`js/light-channel-view.js`](js/light-channel-view.js), [`js/sun-spectrum.js`](js/sun-spectrum.js), [`js/sun.js`](js/sun.js)
...
- [`js/light-page-view.js`](js/light-page-view.js) → [`js/lens-page-shell.js`](js/lens-page-shell.js), [`js/light-conditions-now.js`](js/light-conditions-now.js), [`js/light-channel-view.js`](js/light-channel-view.js), [`js/light-sessions-view.js`](js/light-sessions-view.js), [`js/state.js`](js/state.js), [`js/utils.js`](js/utils.js)
...
- [`js/pdf-import-unit-conversions.js`](js/pdf-import-unit-conversions.js) → [`js/secondary-unit-conversions.js`](js/secondary-unit-conversions.js), [`js/schema.js`](js/schema.js)
- [`js/pdf-import.js`](js/pdf-import.js) → [`js/api.js`](js/api.js), [`js/caught-error.js`](js/caught-error.js), [`js/crypto.js`](js/crypto.js), [`js/cycle-import.js`](js/cycle-import.js), [`js/dna-runtime-bridge.js`](js/dna-runtime-bridge.js), [`js/export.js`](js/export.js), [`js/import-benchmarks.js`](js/import-benchmarks.js), [`js/modal-lifecycle.js`](js/modal-lifecycle.js), [`js/pdf-import-ai-utils.js`](js/pdf-import-ai-utils.js), [`js/pdf-import-commit.js`](js/pdf-import-commit.js), [`js/pdf-import-file-handlers.js`](js/pdf-import-file-handlers.js), [`js/pdf-import-file-utils.js`](js/pdf-import-file-utils.js), [`js/pdf-import-marker-mapping.js`](js/pdf-import-marker-mapping.js), [`js/pdf-import-marker-normalization.js`](js/pdf-import-marker-normalization.js), [`js/pdf-import-persistence.js`](js/pdf-import-persistence.js), [`js/pdf-import-preflight.js`](js/pdf-import-preflight.js), [`js/pdf-import-progress.js`](js/pdf-import-progress.js), [`js/pdf-import-review.js`](js/pdf-import-review.js), [`js/pdf-import-spreadsheet.js`](js/pdf-import-spreadsheet.js), [`js/pii.js`](js/pii.js), [`js/privacy-safe-diagnostics.js`](js/privacy-safe-diagnostics.js), [`js/profile.js`](js/profile.js), [`js/settings-runtime-bridge.js`](js/settings-runtime-bridge.js), [`js/schema.js`](js/schema.js), [`js/state.js`](js/state.js), [`js/utils.js`](js/utils.js)
...
<details><summary><code>registry</code> family — 1 module</summary>

- [`js/agent-actions/registry.js`](js/agent-actions/registry.js) → [`js/agent-actions/schemas.js`](js/agent-actions/schemas.js), [`js/sun-sessions-store.js`](js/sun-sessions-store.js) *(dynamic)*
...
- [`js/schema.js`](js/schema.js) → [`js/marker-schema.js`](js/marker-schema.js), [`js/secondary-unit-conversions.js`](js/secondary-unit-conversions.js), [`js/schema-environment.js`](js/schema-environment.js), [`js/state.js`](js/state.js)

</details>

<details><summary><code>schemas</code> family — 1 module</summary>

- [`js/agent-actions/schemas.js`](js/agent-actions/schemas.js) → no in-scope imports
...
- [`js/sync-payload.js`](js/sync-payload.js) → [`js/nutrition-sync-sanitize.js`](js/nutrition-sync-sanitize.js), [`js/sync-payload-codec.js`](js/sync-payload-codec.js), [`js/sync-payload-collectors.js`](js/sync-payload-collectors.js), [`js/sync-profile-fields.js`](js/sync-profile-fields.js)
...
<details><summary><code>dev</code> family — 5 modules</summary>

- [`lib/dev-agent-proposal-dogfood.js`](lib/dev-agent-proposal-dogfood.js) → no in-scope imports
- [`lib/dev-agent-proposal-proxy.js`](lib/dev-agent-proposal-proxy.js) → no in-scope imports
...
- [`dev-server.js`](dev-server.js) → [`lib/dev-agent-proposal-dogfood.js`](lib/dev-agent-proposal-dogfood.js), [`lib/dev-agent-proposal-proxy.js`](lib/dev-agent-proposal-proxy.js), [`lib/dev-api-proxy.js`](lib/dev-api-proxy.js), [`lib/dev-catalog.js`](lib/dev-catalog.js), [`lib/dev-url-fetch.js`](lib/dev-url-fetch.js), [`lib/proxy-policy.js`](lib/proxy-policy.js)
