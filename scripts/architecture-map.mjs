...
function renderMap(architecture, rules) {
  ...
  const lines = [
    ...
    '',
    'The human-maintained architecture contract is in [`ARCHITECTURE.md`](ARCHITECTURE.md). This map covers first-party ESM under `js/`, `api/`, and `lib/`, plus the local `dev-server.js` entry point; tests, tooling, vendored code, CSS, and data assets are outside the graph.',
    '',
    '## Snapshot',
    '',
    '| Metric | Current |',
